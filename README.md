...
driftctl\-slack is a golang wrapper to send driftctl scan summary to slack\. This is accompanied by a \[Terraform module\]\(https://github.com/nomadops/terraform-aws-driftctl-slack\) to deploying as a scheduled ECS task Usage:
